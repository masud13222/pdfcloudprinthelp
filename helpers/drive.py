    ...
    try:
        ...
        if len(command_parts) != 2:
            await message.reply_text(
                "❌ **দয়া করে সঠিক ফরম্যাটে কমান্ড দিন।**\n\n"
                "**📝 ফিচারসমূহ:**\n"
                "• Google Drive PDF ডাউনলোড করা\n"
                "• রিয়েল-টাইম প্রগ্রেস আপডেট\n"
                "• স্বয়ংক্রিয়ভাবে ফাইল নাম ডিটেকশন\n"
                "• অপটিমাইজড ইমেজ কোয়ালিটি\n"
                "• ফাইল সাইজ অপটিমাইজেশন\n\n"
                "**🔄 ব্যবহার পদ্ধতি:**\n"
                "1️⃣ /pdf <Google Drive লিংক/ফাইল ID>\n"
                "2️⃣ প্রসেস শেষ হওয়া পর্যন্ত অপেক্ষা করুন\n\n"
                "**💡 উদাহরণ:**\n"
                "`/pdf https://drive.google.com/file/d/xxx/view`\n"
                "`/pdf xxx`"
            )
            return
